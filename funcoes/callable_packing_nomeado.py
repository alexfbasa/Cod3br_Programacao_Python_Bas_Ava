def calc_preco_final(preco_bruto, calc_imposto, **kwargs):
    return preco_bruto + preco_bruto * calc_imposto(**kwargs)
...
print(f"Preço final do produto é {round(preco_final, 2)}")
